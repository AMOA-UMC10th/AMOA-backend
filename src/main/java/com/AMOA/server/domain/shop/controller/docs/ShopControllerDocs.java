...
public interface ShopControllerDocs {
    ...
    @Operation(summary = "샵 이름으로 카카오 로컬 API 검색", description = "샵 이름으로 카카오 로컬 API를 검색하여 주소, 전화번호, 영업시간을 자동완성합니다.")
    ...
    ApiResponse<ShopResDTO.CreateShopResponse> createShop(@RequestBody ShopReqDTO.CreateShopRequest request);
}